...
We believe that these techniques are poised to fundamentally shift much of how the government (and beyond) thinks about, uses, and gains insights from data. FY22 saw an <a class="usa-link usa-link--external" rel="noreferrer" target="_blank" href="https://bidenwhitehouse.archives.gov/ostp/news-updates/2022/06/28/advancing-a-vision-for-privacy-enhancing-technologies/">Executive Order around Advancing a Vision for Privacy Enhancing Technologies</a> and a <a class="usa-link usa-link--external" rel="noreferrer" target="_blank" href="https://www.nitrd.gov/coordination-areas/privacy-rd/appdsa/">Fast Track Action Committee</a> to develop a cohesive national strategy to advance privacy-preserving data sharing and analytics.

We're proud to fund <a class="usa-link usa-link--external" rel="noreferrer" target="_blank" href="https://www.xd.gov/">xD</a>, an emerging technologies group at the U.S. Census Bureau, for this project which is currently in Phase Three. In FY22, they represented the U.S. in an international collaboration of statistical agencies as part of the newly formed United Nations Privacy Enhancing Technologies Lab.
