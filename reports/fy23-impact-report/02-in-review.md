...
Sometimes an idea reflects <em>both</em> of our investment themes. A good example of this is an idea we received called <a class="usa-link usa-link--external" rel="noreferrer" target="_blank" href="https://trello.com/c/BkfVw9Ip">"De-Biasing Public Infrastructure Investments</a>." The observation of this investment is that government investments in public infrastructure do not always take into account possible negative effects that these investments can have on local populations, and in particular, vulnerable communities. For example, a city might build a much-needed highway, but in a way that divides a lower-income neighborhood and displaces residents.
